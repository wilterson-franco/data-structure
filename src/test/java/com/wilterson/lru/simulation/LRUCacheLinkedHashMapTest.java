...
class LRUCacheLinkedHashMapTest {
    ...
    void whenEmptyCache_thenItemShouldBeAdded(SimLRUCache<Integer, String> cache) {
    ...
    @ParameterizedTest
    @MethodSource("buildConcreteCache")
    void whenFullCache_thenOldestShouldBeEvicted(SimLRUCache<Integer, String> cache) {
    ...
    @ParameterizedTest
    @MethodSource("buildConcreteCache")
    void whenItemAccessed_thenItShouldMoveToTop(SimLRUCache<Integer, String> cache) {
    ...
    @ParameterizedTest
    @MethodSource("buildConcreteCache")
    void whenItemUpdated_thenGetShouldReturnNewValue(SimLRUCache<Integer, String> cache) {
    ...
    @ParameterizedTest
    @MethodSource("buildConcreteCache")
    void whenDuplicateValueUnderDifferentKeys_thenCacheShouldHaveSizeTwo(SimLRUCache<Integer, String> cache) {
    ...
    @ParameterizedTest
    @MethodSource("buildConcreteCache")
    void givenFullCacheWithTwoValuesUnderDifferentKeys_whenFirstItemRemoved_thenFirstItemShouldNotBeInTheCache(SimLRUCache<Integer, String> cache) {
    ...
    private static Stream<Arguments> buildConcreteCache() {
        return Stream.of(
                Arguments.of(new LRUCacheLinkedHashMap<>(3)),
                Arguments.of(new LRUCacheWithLinkedList<>(3)),
                Arguments.of(new LRUCacheWithCustomLinkedList<>(3)));
    }
}
